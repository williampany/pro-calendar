...
//在当前时间上添加月数
    ...
    * */
    ...
    calendar.showCalendarData = function(d){
        ...
        var _dateStr = formatDateString(d);
        ...
        function renderCell(tds){
            ...
            for(var i = 0; i < tds.length; i++) {
                ...
                }else if(_thisDay.equalsYearAndMonth(_firstDay)) {
